...
- Add or update documentation when behavior or installation changes.
- Do not include generated build products, signing credentials, or personal configuration files.
